...
import com.iiordanov.bVNC.input.RemoteRdpPointerNul;
...
public class RemoteCanvas extends AppCompatImageView
    ...
    private void initializeRdpConnection() throws Exception {
        ...
        if (connection.getKioskMode())  //kioskmode use a pointer with no function
            pointer=new RemoteRdpPointerNul(rfbconn, RemoteCanvas.this, handler);
        else
    ...
    private void startRdpConnection() throws Exception {
        ...
        bKioskMode=connection.getKioskMode(); //kioskmode
        ...
        if(connection.getKioskMode()) //kioskmode
            pointer.movePointer(remoteWidth,remoteHeight);
    }
    ...
    void initializeSoftCursor() {
        Log.d(TAG, "initializeSoftCursor: ...");
