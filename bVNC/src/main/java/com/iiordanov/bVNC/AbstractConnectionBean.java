...
public abstract class AbstractConnectionBean extends com.antlersoft.android.dbimpl.IdImplementationBase implements IConnectionBean {
    ...
    public static final int GEN_COUNT = 83;//kioskmode 82;
    ...
    "PREFERSENDINGUNICODE INTEGER," +
            "USEKIOSKMODE BOOLEAN" + //kioskmode
    ")";
    ...
    private boolean gen_usekioskmode; //kioskmode
    ...
    //kioskmode
    public boolean getUseKioskMode() { return gen_usekioskmode; }
    ...
    public int[] Gen_columnIndices(android.database.Cursor cursor) {
        ...
        //kioskmode
        result[82] = cursor.getColumnIndex(GEN_FIELD_USEKIOSKMODE);
        return result;
    }
